...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            @include('qal.audit_rutin.informasi_anggota')
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('qal.audit.rutin.tambah', $data_sampling_detail->id) }}" method="POST"
                        ...
                        <tbody>
                            @foreach ($history_audit as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/qal/audit-rutin/history/' . $item->id . '/' . $item->cif) }}"
...
@push('scripts')
    ...
    <script>
        ...
        $('#formTemuanLain').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('qal.audit.rutin.temuan-lain.store', ['id_ref_sampling' => $data_sampling_detail->id_ref_sampling, 'cif' => $data_sampling_detail->cif]) }}",
                method: "POST",
                data: formData,

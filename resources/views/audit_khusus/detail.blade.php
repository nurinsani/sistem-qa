...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            @include('audit_khusus.informasi_anggota')
        ...
        @include('audit_khusus.modal_ketentuan')
        @include('audit_khusus.modal_temuan_lain')
        @include('audit_khusus.modal_ketentuan_temuan_lain')
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script>
        ...
        $('#formKetentuan').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('audit.khusus.ketentuan.store', ['id_ref_sampling' => $data_sampling_detail->id_ref_sampling, 'cif' => $data_sampling_detail->cif]) }}",
                method: "POST",
                data: formData,
        ...
        $('#formTemuanLain').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('audit.khusus.temuan-lain.store', ['id_ref_sampling' => $data_sampling_detail->id_ref_sampling, 'cif' => $data_sampling_detail->cif]) }}",
                method: "POST",
                data: formData,
                success: function(response) {

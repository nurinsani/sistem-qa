...
class AuditRutinController extends Controller
{
    public function index()
    {
        ...
        return view('qal.audit_rutin.index', compact('menus', 'title'));
    }
    ...
    public function detail($id, $cif)
    {
        ...
        return view('qal.audit_rutin.detail', compact(
            'menus',
            'title',
    ...
    public function historyAudit($cif)
    {
        ...
        return view('qal.audit_rutin.detail', compact('history_audit'));
    }

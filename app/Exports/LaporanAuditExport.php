    ...
    public function collection()
{
    ...
    // 2. Ambil daftar 'kode_unit' yang dimiliki user dari tabel masterqa
    $unitsUser = DB::table('masterqa')
        ->where('code_qa', $user->code_qa)
        ->pluck('kode_unit');

    // 3. Query dengan filter mapping area
    return DB::table('data_sampling')
        ...
        // Filter mapping: Hanya ambil data yang area-nya masuk dalam daftar yang dimiliki user

...
@section('content')
    <div class="container-fluid">
                ...
                <form method="GET" action="{{ route('qal.laporan.index') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            ...
                            <a href="{{ route('qal.laporan.index') }}" class="btn btn-secondary">
                                Reset
                            </a>
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('qal.laporan.index') }}" method="GET">
                    <div class="row">
                        <!-- Tanggal Awal Rekap -->
                        <div class="col-md-3">
                ...
                @if (request()->filled('rekap_tgl_awal') || request()->filled('rekap_tgl_akhir') || request()->filled('periode'))
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        @if (request()->filled('user_id'))
                            <a href="{{ route('qal.laporan.index', array_filter(['rekap_tgl_awal' => request('rekap_tgl_awal'), 'rekap_tgl_akhir' => request('rekap_tgl_akhir'), 'periode' => request('periode')])) }}"
                            ...
                            <tbody>
                                @forelse($rekapData as $rekap)
                                    <tr
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('qal.laporan.index', array_filter(['rekap_tgl_awal' => request('rekap_tgl_awal'), 'rekap_tgl_akhir' => request('rekap_tgl_akhir'), 'periode' => request('periode'), 'user_id' => $rekap->user_id])) }}"
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    @if ($data->count() > 0)
                        <a href="{{ route('qal.laporan.export_excel', request()->all()) }}" class="btn btn-success btn-sm">
                            ...
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('qal.laporan.pdf', $item->id) }}" target="_blank"

...
<div class="container-fluid">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title">Filter Fraud Alert</h3>
        </div>

        <div class="card-body">

            <form method="GET" action="{{ route('qam.fraud.alerts') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('qam.fraud.alerts') }}" class="btn btn-secondary">
                            Reset
                        </a>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h3 class="card-title">Data Fraud Alert</h3>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('qam.fraud.alerts.export', [

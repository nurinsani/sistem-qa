...
class QalTanggapanController extends Controller
{
    public function index()
    {
        ...
        return view('qal.tanggapan.index', compact('menus', 'title'));
    }
...
$data_sampling = DataSampling::with(['branch', 'kelompok', 'ao'])
    ...
    public function detail($id, $cif)
    {
        ...
        return view('qal.tanggapan.detail', compact(
            'menus',
            'title',
            'audit',
            'data_api',
    ...
    public function edit($id, $cif)
    {
        ...
        return view('qal.tanggapan.edit', compact(
            'menus',
            'title',
            'audit',
            'data_api',

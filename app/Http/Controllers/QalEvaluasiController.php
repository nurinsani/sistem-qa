...
class QalEvaluasiController extends Controller
{
    public function index()
    {
        ...
        return view('qal.evaluasi.index', compact('menus', 'title'));
    }
    ...
    public function detail($id, $cif)
    {
        ...
        return view('qal.evaluasi.detail', compact(
            'menus',
            'title',
            'audit',
            'data_api',
    ...
    public function edit($id, $cif)
    {
        ...
        return view('qal.evaluasi.edit', compact(
            'menus',
            'title',
            'audit',
            'data_api',
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect()->route('qal.evaluasi.index')->with('success', 'Evaluasi berhasil disimpan');
    }

...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <a href="{{ route('qal.tanggapan.index') }}" class="btn btn-primary mb-3">
            ← Kembali
        </a>

        @include('qal.tanggapan.form_hasil_audit')
        @include('qal.tanggapan.modal_foto_hasil_audit')
        @include('qal.tanggapan.modal_temuan_lain')
        @include('qal.tanggapan.modal_ketentuan_temuan')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="tanggapan_al" id="tanggapan_al" cols="10" rows="3"
                                    class="form-control @error('tanggapan_al') is-invalid @enderror">{{ old('tanggapan_al', $tanggapan->tanggapan_al ?? '') }}</textarea>
                                @error('tanggapan_al')
                                    <div class="invalid-feedback mt-2">
                                        {{ $message }}
                                    </div>

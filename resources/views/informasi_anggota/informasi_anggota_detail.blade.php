...
<div class="container">
                ...
                <div class="col-md-9">
                    <table class="table table-borderless table-sm">
                        ...
                        <tr>
                            <td>Tanggal Join</td>
                            <td>:</td>
                            <td>{{ date('d M Y', strtotime($dataCif['tgljoin'])) }}</td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td>:</td>
    ...
    <div class="card w-100 shadow-sm mt-4">
        ...
        <div class="card-body text-center">
            ...
            <a href="{{ route('mutasi_anggota_print', request('cif')) }}" class="btn btn-primary"
                data-bs-toggle="modal" data-bs-target="#akadModal" data-pdf="" target="_blank">

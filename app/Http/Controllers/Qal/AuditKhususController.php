...
class AuditKhususController extends Controller
{
    public function index()
    {
        ...
        return view('qal.audit_khusus.index', compact('menus', 'title'));
    }
    ...
    public function detail($id, $cif)
    {
        ...
        return view('qal.audit_khusus.detail', compact(
            'menus',
            'title',

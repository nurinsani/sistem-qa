...
class PengurusController extends Controller
{
    public function index()
    {
        ...
        return view('pengurus.dashboard', compact('title', 'menus', 'dataBulanan'));
    }
    ...
    // Ambil data dan kelompokkan berdasarkan email QA
    $auditsGrouped = DataSampling::with('qa')
        ->whereMonth('created_at', $bulan)
        ->whereYear('created_at', $tahun)
        ->get()
        ->groupBy('user_id'); // Kelompokkan berdasarkan ID

        return view('pengurus.dashboard.detail', compact('title', 'menus', 'auditsGrouped', 'bulan', 'tahun'));
    }
    ...
    public function detailAudit($id, $cif)
    {
        ...
        return view('pengurus.dashboard.detail_audit', compact(
            'menus',
            'title',
            'audit',
            'data_api',

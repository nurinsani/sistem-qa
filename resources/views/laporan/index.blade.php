                ...
                @if (request()->filled('rekap_tgl_awal') || request()->filled('rekap_tgl_akhir') || request()->filled('periode'))
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        @if (request()->filled('user_id'))
                            <a href="{{ route('laporan.index', array_filter(['rekap_tgl_awal' => request('rekap_tgl_awal'), 'rekap_tgl_akhir' => request('rekap_tgl_akhir'), 'periode' => request('periode')])) }}"
                            ...
                            <tbody>
                                @forelse($rekapData as $rekap)
                                    <tr
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('laporan.index', array_filter(['rekap_tgl_awal' => request('rekap_tgl_awal'), 'rekap_tgl_akhir' => request('rekap_tgl_akhir'), 'periode' => request('periode'), 'user_id' => $rekap->user_id])) }}"
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    @if ($data->count() > 0)
                        <a href="{{ route('laporan.export_excel', request()->all()) }}" class="btn btn-success btn-sm">
                            ...
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('laporan.pdf', $item->id) }}" target="_blank"
